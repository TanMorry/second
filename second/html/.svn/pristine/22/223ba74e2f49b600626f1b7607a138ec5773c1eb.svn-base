	...
	var methods = {
		init: function (options) {
			...
			return this.each(function () {
				...
				if(opts.modal)
				{
					$this.before("<div class='miao-shade' miao='miao-full-shade' style='position:fixed;z-index:9998;top:0;left:0;width:100%;height:100%;background:#000;opacity:0;filter:alpha(opacity:50);display:" + display + "'></div>");
				}
			});
		},
		close: function (anim) {
