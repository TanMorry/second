...
! function(a, b) {
	...
	var e, f, h, i,
		...
		g = {
			hosts: function() {
				...
				return a = a ? a[0] : "", "http://" + document.domain + a + "/"
			}(),
			getPath: function() {
	...
	a.layer = {
		...
		use: function(a, b) {
			...
			a = a.replace(/\s/g, ""), f = /\.css$/.test(a), g = document.createElement(f ? "link" : "script"), h = a.replace(/\.|\//g, ""), f && (g.setAttribute("type", "text/css"), g.setAttribute("rel", "stylesheet")), g.setAttribute(f ? "href" : "src", layer.path + a), g.setAttribute("id", h), e("#" + h)[0] || d.appendChild(g), e(g).ready(function() {
				b && b()
			})
		},
		ready: function(a) {
		...
		msg: function(a, c, d, f) {
			...
			return ("" == a || a == b) && (a = "&nbsp;"), c === b && (c = 2), "number" == typeof d ? g = d : (d = d || {}, g = d.type, h.success = function() {
				layer.shift(d.rate)
			}, h.shade = d.shade), h.time = c, h.dialog = {
				msg: a,
				type: g
			}, h.end = "function" == typeof d ? d : f, e.layer(h)
		},
		load: function(a, b) {
		...
		var b = this.config;
		layer.index++, this.index = layer.index, this.config = e.extend({}, b, a), this.config.dialog = e.extend({}, b.dialog, a.dialog), this.config.page = e.extend({}, b.page, a.page), this.config.iframe = e.extend({}, b.iframe, a.iframe), this.config.loading = e.extend({}, b.loading, a.loading), this.config.tips = e.extend({}, b.tips, a.tips), this.creat()
	...
	}, h.pt.type = ["dialog", "page", "iframe", "loading", "tips"], h.pt.space = function(a) {
		...
		switch (g.constructor === Array || (a.config.title = [g, !0]), g === !1 && (a.config.title = [g, !1]), j = c.page, k = e("body"), l = function(c) {
			var c = c || "";
			b = a.space(c), k.append(b[0])
		}, c.type) {
			case 1:
				if ("" !== j.html) l('<div class="xuboxPageHtml">' + j.html + "</div>"), k.append(b[1]);
				else if ("" !== j.url) l('<div class="xuboxPageHtml" id="xuboxPageHtml' + i + '">' + j.html + "</div>"), k.append(b[1]), e.get(j.url, function(a) {
					e("#xuboxPageHtml" + i).html(a.toString()), j.ok && j.ok(a)
				});
				else {
					if (0 != e(j.dom).parents(".xubox_page").length) return;
					l(), e(j.dom).show().wrap(b[1])
				}
				break;
			case 2:
				l(), k.append(b[1]);
				break;
			case 3:
				c.title = ["", !1], c.area = ["auto", "auto"], c.closeBtn = ["", !1], e(".xubox_loading")[0] && layer.close(e(".xubox_loading").parents("." + h.lay).attr("times")), l(), k.append(b[1]);
				break;
			case 4:
				c.title = ["", !1], c.area = ["auto", "auto"], c.fix = !1, c.border = !1, e(".xubox_tips")[0] && layer.close(e(".xubox_tips").parents("." + h.lay).attr("times")), l(), k.append(b[1]), e("#" + h.lay + i).find(".xubox_close").css({
					top: 6,
					right: 7
				});
				break;
			default:
				c.title[1] || (c.area = ["auto", "auto"]), e(".xubox_dialog")[0] && layer.close(e(".xubox_dialog").parents("." + h.lay).attr("times")), l(), k.append(b[1])
		}
		if (this.layerS = e("#xubox_shade" + i), this.layerB = e("#xubox_border" + i), this.layerE = e("#" + h.lay + i), m = this.layerE, this.layerMian = m.find(".xubox_main"), this.layerTitle = m.find(".xubox_title"), this.layerText = m.find(".xubox_text"), this.layerPage = m.find(".xubox_page"), this.layerBtn = m.find(".xubox_botton"), n = -1 != c.offset[1].indexOf("px") ? parseInt(c.offset[1]) : "50%" == c.offset[1] ? c.offset[1] : parseInt(c.offset[1]) / 100 * f.width(), m.css({
				...
				position: "absolute"
			}), c.title[1] && (3 !== c.type || 4 !== c.type)) switch (o = 0 === c.type ? d : c, o.btn = c.btn || d.btn, o.btns) {
			case 0:
				a.layerBtn.html("").hide();
				break;
			case 1:
				a.layerBtn.html('<a href="javascript:;" class="xubox_yes xubox_botton1">' + o.btn[0] + "</a>");
				break;
			case 2:
				a.layerBtn.html('<a href="javascript:;" class="xubox_yes xubox_botton2">' + o.btn[0] + "</a>" + '<a href="javascript:;" class="xubox_no xubox_botton3">' + o.btn[1] + "</a>")
		}
		"auto" === m.css("left") ? (m.hide(), setTimeout(function() {
			m.show(), a.set(i)
		}, 500)) : a.set(i), c.time <= 0 || a.autoclose(), this.callback()
	}, h.pt.set = function(a) {
		...
		switch (b.autoArea(a), d.title[1] ? layer.ie6 && b.layerTitle.css({
			...
			case 1:
				c.find(h.dom).addClass("layer_pageContent"), d.shade[2] && c.css({
					zIndex: d.zIndex + 1
				...
				break;
			case 2:
				k = c.find("." + j.ifr), l = c.height(), k.addClass("xubox_load").css({
					width: c.width()
				}), d.title[1] ? k.css({
			...
			case 3:
				break;
			case 4:
				m = [0, c.outerHeight()], n = e(d.tips.follow), o = {
					width: n.outerWidth(),
					height: n.outerHeight(),
					top: n.offset().top,
					left: n.offset().left
				}, p = c.find(".layerTipsG"), d.tips.isGuide || p.remove(), c.outerWidth() > d.maxWidth && c.width(d.maxWidth), o.tipColor = d.tips.style[1], m[0] = c.outerWidth(), o.where = [function() {
					o.tipLeft = o.left, o.tipTop = o.top - m[1] - 10, p.removeClass("layerTipsB").addClass("layerTipsT").css({
					...
					o.tipLeft = o.left, o.tipTop = o.top + o.height + 10, p.removeClass("layerTipsT").addClass("layerTipsB").css({
						"border-right-color": o.tipColor
					})
				}, function() {
				...
				}], o.where[d.tips.guide](), 0 === d.tips.guide ? o.top - (f.scrollTop() + m[1] + 16) < 0 && o.where[2]() : 1 === d.tips.guide ? f.width() - (o.left + o.width + m[0] + 16) > 0 || o.where[3]() : 2 === d.tips.guide ? o.top - f.scrollTop() + o.height + m[1] + 16 - f.height() > 0 && o.where[0]() : 3 === d.tips.guide && m[0] + 16 - o.left > 0 && o.where[1](), c.css({
					left: o.tipLeft,
					top: o.tipTop
				});
				break;
		...
		switch ("auto" === d.area[0] && g.outerWidth() >= d.maxWidth && c.css({
			...
			case 0:
				p = h.find("a"), m = i.outerHeight() + 20, p.length > 0 && (n = p.outerHeight() + 20);
				break;
			case 1:
				m = e(f.dom).outerHeight(), "auto" === d.area[0] && c.css({
					width: j.outerWidth()
				}), ("" !== f.html || "" !== f.url) && (m = j.outerHeight());
				break;
			case 3:
				m = o.outerHeight(), g.css({
					width: o.width()
				})
		}
		"auto" === d.area[1] && g.css({
		...
		var a = this,
			...
			d = {
				...
				moveLayer: function() {
					var a;
					a = 0 == parseInt(d.layerE.css("margin-left")) ? parseInt(d.move.css("left")) : parseInt(d.move.css("left")) + -parseInt(d.layerE.css("margin-left")), "fixed" !== d.layerE.css("position") && (a -= d.layerE.parent().offset().left, d.setY = 0), d.layerE.css({
						left: a,
						top: parseInt(d.move.css("top")) - d.setY
					})
				}
			};
		b.move[1] && a.layerE.find(b.move[0]).attr("move", "ok"), b.move[1] ? a.layerE.find(b.move[0]).css({
			cursor: "move"
		}) : a.layerE.find(b.move[0]).css({
			cursor: "auto"
		}), e(b.move[0]).on("mousedown", function(a) {
			if (a.preventDefault(), "ok" === e(this).attr("move")) {
				d.ismove = !0, d.layerE = e(this).parents("." + c.lay);
				var g = d.layerE.offset().left,
					h = d.layerE.offset().top,
					i = d.layerE.width() - 6,
					j = d.layerE.height() - 6;
				e("#xubox_moves")[0] || e("body").append('<div id="xubox_moves" class="xubox_moves" style="left:' + g + "px; top:" + h + "px; width:" + i + "px; height:" + j + 'px; z-index:2147483584"></div>'), d.move = e("#xubox_moves"), b.moveType && d.move.css({
					opacity: 0
				}), d.moveX = a.pageX - d.move.position().left, d.moveY = a.pageY - d.move.position().top, "fixed" !== d.layerE.css("position") || (d.setY = f.scrollTop())
			}
			...
			try {
				d.ismove && (d.moveLayer(), d.move.remove()), d.ismove = !1
			} catch (a) {
				d.ismove = !1
			}
			b.moveEnd && b.moveEnd()
		...
		var a = this,
			...
			c = a.config,
			d = c.dialog;
		a.openLayer(), a.config.success(b), layer.ie6 && a.IE6(), b.find(".xubox_close").off("click").on("click", function(b) {
			b.preventDefault(), c.close(a.index)
		}), b.find(".xubox_yes").off("click").on("click", function(b) {
			b.preventDefault(), c.yes ? c.yes(a.index) : d.yes(a.index)
		}), b.find(".xubox_no").off("click").on("click", function(b) {
			b.preventDefault(), c.no ? c.no(a.index) : d.no(a.index)
		...
		h = a.config.fix ? function() {
		...
		}, h(), f.scroll(h), e.each(c, function() {
			var c = e(this);
			...
			e.each(c, function() {
				var c = e(this);
				c.parents("." + d.lay)[0] || 1 == c.attr("layer") && e("." + d.lay).length < 1 && c.removeAttr("layer").show(), c = null
			})
		}
		...
		layer.autoArea = function(b) {
			...
			return c = c || e("." + b.ifr).parents("." + b.lay).attr("times"), e("#" + b.lay + c).find("." + b.ifr).contents().find(a)
		}, layer.getFrameIndex = function(a) {
			return e(a ? "#" + a : "." + b.ifr).parents("." + b.lay).attr("times")
		}, layer.iframeAuto = function(a) {
			var c, d, f, g, h;
			a = a || e("." + b.ifr).parents("." + b.lay).attr("times"), c = this.getChildFrame("body", a).outerHeight(), d = e("#" + b.lay + a), f = d.find(".xubox_title"), g = 0, !f || (g = f.height()), d.css({
				height: c + g
			}), h = -parseInt(e("#xubox_border" + a).css("top")), e("#xubox_border" + a).css({
				height: c + 2 * h + g
			}), e("#" + b.ifr + a).css({
				height: c
			})
			...
			if (d.attr("type") == a.type[1])
				if (d.find(".xuboxPageHtml")[0]) d.remove();
				else
					for (d.find(".xubox_close,.xubox_botton,.xubox_title,.xubox_border").remove(), h = 0; 3 > h; h++) d.find(".layer_pageContent").unwrap().hide();
			else document.all && d.find("#" + b.ifr + c).remove(), d.remove();
			f.remove(), layer.ie6 && a.reselect(), "function" == typeof g.config.end[c] && g.config.end[c](), delete g.config.end[c]
			...
			var j, f = [e("#" + b.lay + c), e("#xubox_border" + c)],
				...
				i = f[0].find(".xubox_title");
			(g === a.type[1] || g === a.type[2]) && (f[0].css(d), h.css({
				height: d.height
				...
				width: parseFloat(d.width) - 2 * parseInt(f[1].css("left")),
				height: parseFloat(d.height) - 2 * parseInt(f[1].css("top"))
			}))
		...
		e = jQuery, f = e(a), layer.use("skin/layer.css"), e.layer = function(a) {
			var b = new h(a);
			return b.index
		}
	}, i = "../../init/jquery", a.seajs ? define([i], function(b, c) {
		g.run(), c.layer = [a.layer, a.$.layer]
	}) : g.run()
}(window);